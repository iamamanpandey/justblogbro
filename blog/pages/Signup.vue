            ...
            <div method="#" action="#" class="mt-10">
              <div>
                <input
                  type="name"
                  placeholder="name"
                  class="mt-1 p-3 block w-full border-none bg-gray-100 h-11 rounded-xl shadow-lg hover:bg-blue-100 focus:bg-blue-100 focus:ring-0"
                  v-model="name"
                />
              </div>
              <div>
                <input
                  type="email"
                  placeholder="Email"
                  class="mt-2 p-3 block w-full border-none bg-gray-100 h-11 rounded-xl shadow-lg hover:bg-blue-100 focus:bg-blue-100 focus:ring-0"
                  v-model="email"
                />
              </div>
              <div class="">
